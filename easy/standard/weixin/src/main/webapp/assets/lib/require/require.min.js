...
*/
var localCachePath = '';
if(window.navigator.userAgent.toLocaleUpperCase().indexOf('ANDROID') != -1) {
    if(window.manifestAndroid && window.manifestAndroid.getCacheRootPath) {
       localCachePath = window.manifestAndroid.getCacheRootPath();
    }
}
