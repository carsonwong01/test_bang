<div class="sicknessPage sicknessbox">
	<div class="layout">
		<h2>灾难救助<a class="explain highlight"><i></i>筹款说明</a></h2>
			...
			<div class="formpage">
				...
				<dl>
					...
					<dd>
						...
						<p class="tips">灾难救助项目，建议上传受灾情况照片和受灾证明图片，提高项目可信度。建议图片尺寸大小870px * 420px。</p>
					</dd>
				</dl>
			</div>
...
<!-- 公共：form表单缓存、附件上传、富文本 -->
<script language="javascript" src="<%=basePath %>easy/js/user/project/projectStart/projectDisasterRelief.js"></script>