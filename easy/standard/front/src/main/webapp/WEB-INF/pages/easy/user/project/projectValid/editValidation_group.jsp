...
<script>
var organizationAptitudeFiles = new Array();
...
var file = {};
//资质证明/营业执照图片
file.imageId = "${dataMap.singleResult.organizationAptitudeId}";
file.imageUrl = "${dataMap.singleResult.organizationAptitudeUrl}";
file.imageExt = "${fn:substringAfter(dataMap.singleResult.organizationAptitudeUrl, '.')}";
file.imageName = "";
file.imageSize = "";
organizationAptitudeFiles.push(file);
//医疗证明图片
...
<div class="sickRelatives sicknessbox">
	<div class="layout">
		<h2 class="mb30">项目验证<span>（
			<c:if test="${dataMap.singleResult.projectType ne '6'}">组织机构验证</c:if>
			<c:if test="${dataMap.singleResult.projectType eq '6'}">企业验证</c:if>
			）</span></h2>
		<form id="validationForm">
			...
			<!-- 非产品急销企业验证 start -->
			<c:if test="${dataMap.singleResult.projectType ne '6'}">
				<div class="sickwhiteBg">
					...
					<div class="formbox">
						<dl>
							...
							<dd>
								<input type="text" id="organizationName" name="organizationName" value="${dataMap.singleResult.organizationName}" validate="q|leng" leng="1,30" maxlength="30" class="input_txt wid92"  placeholder="请填写收款组织名称">
						...
						<dl>
							...
							<dd>
								<input type="text" id="organizationPhone" name="organizationPhone" value="${dataMap.singleResult.organizationPhone}" validate="q|leng|m" leng="1,11" maxlength="11" class="input_txt" placeholder="请填写组织联系手机">
					...
					<div class="sickwhiteBg">
						...
						<div class="formbox">
							...
							<dl>
								...
								<dd>
									<input type="text" id="hospitalName" name="hospitalName" value="${dataMap.singleResult.hospitalRegionName}" validate="q|leng" leng="1,25" maxlength="25" class="input_txt wid92"  placeholder="请填写医院名称">
			...
			<!-- 非产品急销企业验证 end -->
			<!-- 产品急销企业验证 start -->
			<c:if test="${dataMap.singleResult.projectType eq '6'}">
				<div class="sickwhiteBg">
					...
					<div class="formbox">
						<dl>
							...
							<dd>
								<input type="text" id="receiveRealName" name="receiveRealName" value="${dataMap.singleResult.receiveRealName}" validate="q|leng" leng="1,15" maxlength="15" class="input_txt wid92" placeholder="请填写法人真实姓名">
						...
						<dl>
							<dt><span class="red">*</span>身份证号</dt>
							<dd>
								<input type="text" id="receiveIdCard" value="${dataMap.singleResult.receiveIdCard}" validate="q|leng|idCard" leng="1,18" maxlength="18" class="input_txt wid92" placeholder="请填写法人身份证号">
						...
						<dl>
							<dt><span class="red">*</span>联系手机</dt>
							<dd>
								<input type="text" id="receivePhone" name="receivePhone" value="${dataMap.singleResult.receivePhone}" validate="q|leng|m" leng="1,11" maxlength="11" class="input_txt" placeholder="请填写法人联系手机">
...
<!-- 公共：form表单缓存、附件上传、富文本 -->
<script language="javascript" src="<%=basePath %>easy/js/user/project/projectValid/editValidation_group.js"></script>