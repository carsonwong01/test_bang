<div class="sicknessPage sicknessbox">
	<div class="layout">
		<h2>动物保护<a class="explain highlight"><i></i>筹款说明</a></h2>
			...
			<div class="formpage">
				...
				<dl>
					...
					<dd>
						...
						<p class="tips">动物保护项目，建议上传动物拍照，提高项目可信度。建议图片尺寸大小870px * 420px。</p>
					</dd>
				</dl>
			</div>
...
<!-- 公共：form表单缓存、附件上传、富文本 -->
<script language="javascript" src="<%=basePath %>easy/js/user/project/projectStart/projectAnimalProtect.js"></script>