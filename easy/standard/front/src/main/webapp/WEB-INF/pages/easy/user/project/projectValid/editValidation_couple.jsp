...
var weddingPictureFiles = new Array();
var file = {};
//收款人身份证图片
...
//结婚证图片
file = {};
file.imageId = "${dataMap.singleResult.weddingPictureId}";
file.imageUrl = "${dataMap.singleResult.weddingPictureUrl}";
file.imageExt = "${fn:substringAfter(dataMap.singleResult.weddingPictureUrl, '.')}";
file.imageName = "";
file.imageSize = "";
weddingPictureFiles.push(file);
//医疗证明图片
...
<!-- 公共：form表单缓存、附件上传、富文本 -->
<script language="javascript" src="<%=basePath %>easy/js/user/project/projectValid/editValidation_couple.js"></script>