<div class="sicknessPage sicknessbox">
	<div class="layout">
		<h2>扶贫助学<a class="explain highlight"><i></i>筹款说明</a></h2>
...
<!-- 公共：form表单缓存、附件上传、富文本 -->
<script language="javascript" src="<%=basePath %>easy/js/user/project/projectStart/projectPovertyRelief.js"></script>