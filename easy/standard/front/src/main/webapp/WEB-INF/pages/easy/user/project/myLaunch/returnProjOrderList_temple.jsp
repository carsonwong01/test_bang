	...
	<div class="u-table-screening">
		<form id="dataForm" action="">
			...
			<ul class="clearfix">
				...
				<li><span class="pr5">回报金额:</span><select name="supportAmount"
...
{{if status == '9'}}已失败{{/if}}
					...
					<td class="view-link">
{{if status == '4'}}<a  href="javascript:void(0)" onclick="projectManageController.goOrderDetail('{{= orderId}}','qrfh')" class="highlight">发货</a>{{/if}}
<a  href="javascript:void(0)" onclick="projectManageController.goOrderDetail('{{= orderId}}','ckxq')" class="highlight">查看</a></td>
		</tr>
	{{/each}}
</script>
