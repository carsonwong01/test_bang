<div class="sicknessPage sicknessbox">
	<div class="layout">
		<h2>其他救助<a class="explain highlight"><i></i>筹款说明</a></h2>
			...
			<div class="formpage">
				...
				<dl>
					...
					<dd>
						...
						<p class="tips">其他救助项目，建议上传患者治疗中的照片、患者患病前后生活照对比、医院诊断证明等照片，提高项目可信度。建议图片尺寸大小870px * 420px。</p>
					</dd>
				</dl>
			</div>
...
<!-- 公共：form表单缓存、附件上传、富文本 -->
<script language="javascript" src="<%=basePath %>easy/js/user/project/projectStart/projectOtherRelief.js"></script>