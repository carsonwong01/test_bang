...
<form id="hosPro_form" action="<%=basePath%>hospital/hospitalProjectSumAjax.do">
    <input type="hidden" id="hospialId" name="hospitalId" value="${hospitalDetails.hospitalId}"/>
</form>
<div class='center'>
    <div class='benderD'>
        ...
        <div class='top-ns'>
            <div class='fl img-b'><img src="${hospitalDetails.logoUrl}"></div>
            <div class='fr frt-xq'>
                <p class='pop-s'>${hospitalDetails.hospitalName}
                    <span>${hospitalDetails.hospitalGrade}</span><span>${hospitalDetails.hospitalType}</span></p>
                <div class='daohxi'>
                    <div class='jqrt'>
                        <p>
    ...
    <div class='men-ded'>
        ...
        <div class='fl fl-cen'>
            <ul>
                <li data='#donations' class='actionk ldr' datr='${hospitalDetails.hospitalId}'
                >推荐项目
                </li>
            ...
            <div class='centsd'>
                ...
                <div id='record' class='record'>
                    <table>
                        <thead>
                        <tr>
                            <th style='width:67px'>求助时间</th>
                            <th style='width:43px'>受助人</th>
                            <th style='width:150px'>求助标题</th>
                            <th style='width:180px'>项目进度</th>
                            <th style='width:69px'>
                                <div class='igb-d'>
                                    <select name="select" id="select_k1" class="xla_k">
                                        <option value="选择品牌">完成状态</option>
                                        <option value="选择品牌1">筹款中</option>
                                        <option value="选择品牌2">已结束</option>
                                    </select>
                                    <b></b>
                                </div>
                            </th>
...
//                alert(data.hosProjectSum.pageResult.list)
                var data = data.hosProjectSum.pageResult.list;
                var strs = $('#ttxou').html('');
                var bady = $('#list').html('');
                var tod = '';
                var boy = '';
                $.each(data, function (i, n) {
                    tod += "<li>" +
                        ...
                        "<li>已筹金额（元）</br> <span>"+n.raisedAmount+"</span></li>" +
