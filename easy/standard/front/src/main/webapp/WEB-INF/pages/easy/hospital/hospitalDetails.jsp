...
<div class='center'>
    ...
    <div class='men-ded'>
        ...
        <div class='fl fl-cen'>
            ...
            <div class='centsd'>
                <div id='donations'>
                    <form id="hospitalProjectForm" method="post">
                    <input name="hospitalId" type="hidden" value="${hospitalDetails.hospitalId}">
                    </form>
        ...
        <div class='fr fr-nav'>
            ...
            <div class='problem'>
                ...
                <ul class='loko'>
                    <li>捐款总额：<span>${hospitalDetails.allTargetAmount}</span>	元</li>
