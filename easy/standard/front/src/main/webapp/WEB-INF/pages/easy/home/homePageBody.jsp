	<%@ taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core" %>
		...
		<li>
		<img src="{{= objInfo.projectImg}}" onclick="location.href='<%=basePath %>project/projectDetails.do?projectId={{= objInfo.projectId}}'">
		<div class='detailed'>
		...
		<li><a href="<%=basePath%>hospital/hospitalDetails.do?hospitalId={{= obj.hospitalId}}">{{= obj.hospitalName}}</a></li>
		{{/each}}
		...
		<p><span>{{= obj.partnerType}}：<span></span></span><span>{{= obj.partnerName}}</span><div class='clear'></div></p>
		{{/each}}
		</div>
		</div>
