					...
					$.each(
						...
						function(index,item) {
							...
							switch (item.tradeType) {
								...
								case "2":
									// 项目相关
									html += "<li class=\"item\"><div class=\"clearfix\"><div class=\"mod_l\"><div class=\"pic\"><a href=\"javascript:void(0)\" onclick=\"userCenterController.goProjectDetails('"+ item.projectId+"')\"><img src=\""+item.coverImage+"\" /></a> </div> <div class=\"info pt10\"><div class=\"til\"> <a href=\"javascript:void(0)\" onclick=\"userCenterController.goProjectDetails('"+ item.projectId+"')\">"+item.projectName+"</a><span class=\"state\">"+((item.tradeType=="1" || item.tradeType=="2")?"众筹成功":"") +"</span> </div> <p class=\"time\">"+item.dateCreate+"</p> </div> </div> <div class=\"mod_r\"> <div class=\"con\"> <span class=\"money\">"+(item.capitalDirection=="1"?"+":"-")+item.tradeAmount+"</span> "+(item.accountType=="1"?"<span class=\"type highlight2\">可用金额</span>":"<span class=\"type red\">冻结金额</span>")+"	</div> 	</div> 	</div> </li>";
								break;
								case "3":
								case "4":
									// 提现相关
