...
<div>
        ...
        <div class="pl140"><a href="javascript:searchLoanWithdraw.auditWithdrawLoan('1');"  class="btn btn-blue radius-6 mr10  pl20 pr20">审核通过</a>
               <a href="javascript:searchLoanWithdraw.auditWithdrawLoan('2');"  class="btn btn-blue radius-6 mr10  pl20 pr20">审核不通过</a>
