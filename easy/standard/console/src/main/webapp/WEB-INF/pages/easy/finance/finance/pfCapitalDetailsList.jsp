...
<div class="p20">
<form id="searchPFCapitalDetailsListForm">
  <div class="border">
    <div class="title-container"><i class="icon-i w30 h30 va-middle title-left-icon"></i><span id="detailHtml">平台资金明细</span></div>
    <div class="content-container pl40 pt30 pr40 pb20">
      ...
      <li><div class="item-box"><span class="display-ib mr5">类型：</span>
        ...
        <shiro:hasPermission name="CWGL_TKGL_PTZJMX_DC">
  ...
  <div class="mt20 table-container">
    <table class="table table-style gray6 tc">
      ...
      <tbody class="f12" id="searchPFCapitalDetailsListD"></tbody>
      </tbody>
    </table>
  </div>
   <!--分页-->
  <div class="paging"  id="searchPFCapitalDetailsListTag"></div>
  <!--分页 end-->
  <!--导出标题  -->
  <table id="exportTable" hidden="true">
      <thead>
        <tr>
          ...
          <th exp-name="accountBalance">账户结余（元）</th>
...
<script id="searchPFCapitalDetailsListTemp" type="text/x-jquery-tmpl">
...
<script language="javascript" src="<%=basePath %>js/easy/finance/finance/pfCapitalDetailsList.js"></script>