...
<div class="p20">
	...
	<div class="mt20 table-container">
		<table class="table table-style gray6 tc">
			...
			<tbody class="f12" id="publicWelfareProOrderList"></tbody>
			</tbody>
		</table>
	</div>
	<div>
	...
	<!--分页-->
	<div class="paging" id="publicWelfareProOrderListTag"></div>
	<!--分页 end-->

</div>

<script id="publicWelfareProOrderListTemp" type="text/x-jquery-tmpl">
...
<script language="javascript"
	src="<%=basePath%>js/easy/bus/orderManage/publicWelfareProOrderList.js"></script>