...
<div class="p20">
		...
		<div class="border">
			...
			<div class="content-container pl40 pt30 pr40 pb20">
				<ul class="gray6 input-list-container clearfix">
					...
					<li><div class="item-box">
							<input type="hidden" name="projectType" value="7"/>
							<input type="hidden" name="projectId" value="${projectId}" /> <a
								class="btn btn-blue radius-6 mr5 pl1 pr15" id="search"><i
	...
	<div class="mt20 table-container">
		<table class="table table-style gray6 tc">
			...
			<tbody class="f12" id="dreamProOrderList"></tbody>
			</tbody>
		</table>
	</div>
	<div>
		订单数量：<span id="orderTotalCount">0</span>个
	</div>
	<!--分页-->
	<div class="paging" id="dreamProOrderListTag"></div>
	<!--分页 end-->

</div>

<script id="dreamProOrderListTemp" type="text/x-jquery-tmpl">
...
<script language="javascript"
	src="<%=basePath%>js/easy/bus/orderManage/dreamProOrderList.js"></script>