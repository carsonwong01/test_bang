...
<div class="p20">
<form id="searchRefundFailedListForm">
  <div class="border">
    <div class="title-container"><i class="icon-i w30 h30 va-middle title-left-icon"></i><span id="detailHtml">订单退款失败</span></div>
    <div class="content-container pl40 pt30 pr40 pb20">
      <ul class="gray6 input-list-container clearfix">
        ...
        <shiro:hasPermission name="CWGL_TKGL_DDTKSB_DC">
  ...
  <div class="mt20 table-container">
    <table class="table table-style gray6 tc">
      ...
      <tbody class="f12" id="searchRefundFailedListD"></tbody>
      </tbody>
    </table>
  </div>
   <!--分页-->
  <div class="paging"  id="searchRefundFailedListTag"></div>
  <!--分页 end-->
  <!--导出标题  -->
...
<script id="searchRefundFailedListTemp" type="text/x-jquery-tmpl">
{{each(i,data) pageResult.list}}   
       <tr {{if i %2 == 0}}class="tr-even" {{/if}}>
          ...
          <td>
          <shiro:hasPermission name="CWGL_TKGL_DDTKSB_TK">
          <a href="javascript:void(0);"onclick="searchRefundFailedList.refundOperation('{{= data.id}}');" class="link-blue ml10 mr10">退款</a>
          </shiro:hasPermission>
          </td>
        </tr>
{{/each}}
...
<script language="javascript" src="<%=basePath %>js/easy/finance/refund/refundFailedList.js"></script>