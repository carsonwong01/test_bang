				...
				<ul class="gray6 pt20">
					<li class="mb20">
						<div class="pr mh30 pl160">
							...
							<div class="tl h30 lh30">${proDetail.initiator }(${proDetail.initiatorNickName })</div>
						</div>
					</li>
					<li class="mb20">
						<div class="pr mh30 pl160">
					...
					<%-- <li class="mb20">
						<div class="pr mh30 pl160">
							<span class="display-ib w140 lh30 tr mr5 pa left0 top0">公益类型：</span>
							<div class="tl h30 lh30">
								<c:if test="${proDetail.type=='1' }"> 大病救助 </c:if>
								<c:if test="${proDetail.type=='2' }"> 灾难救助  </c:if>
								<c:if test="${proDetail.type=='3' }"> 动物保护 </c:if>
								<c:if test="${proDetail.type=='4' }"> 扶贫助学 </c:if>
								<c:if test="${proDetail.type=='5' }"> 其他  </c:if>
							</div>
						</div>
					</li> --%>
					<li class="mb20">
							  ...
							  <div class="tl">
							    <ul class="gray6 input-list-container clearfix">
							     <li>
							      ...
							      <c:forEach var="item" items="${proDetail.imgs}" varStatus="index">
