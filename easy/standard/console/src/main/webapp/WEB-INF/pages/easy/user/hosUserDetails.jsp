    ...
    <div class="border mt20">
        <div class="tabnav-container">
            <ul class="clearfix pr pr100">
                ...
                <li class="pa right0 top5 mr5"><a class="btn-blue2 btn white radius-6 pl20 pr20 f14 click-link" href="javascript:void(0);" data-url="userManage/hospitalUserList.do" >返回</a></li>
            </ul>
        </div>
...
<script language="javascript" src="<%=basePath %>js/easy/user/hosUserDetails.js"></script>
